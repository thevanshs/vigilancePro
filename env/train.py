...
class traindata:
 ...
 # main background
        ...
        #top label
        title_lbl=Label(f_lbl,text="Tain Data Module",font=("Roboto",35,"bold"),bg="#00022D",fg="whitesmoke")
        ...
        b2=Button(f_lbl,image=self.photoimg3,cursor="hand2",command=self.train_classifier)
        b2.place(x=540,y=200,width=220,height=220)
       
        b2_txt=Button(f_lbl,text="Train data",font=("Roboto",12,"bold"),bg="black",fg="whitesmoke",cursor="hand2",command=self.train_classifier)
    ...
    def train_classifier(self):
        ...
        messagebox.showinfo("Result","Train Datasets Completed",parent=self.root)
