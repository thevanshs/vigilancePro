...
# Load pre-trained face and full-body detectors
...
def detect_movement(frame, roi, face_detected, body_detected):
...
def main():
    ...
    while True:
        ...
        body_detected = detect_bodies(frame)

        # Detect human movement only if a face or body is detected
        frame = detect_movement(frame, roi, face_detected, body_detected)
